...
function DashboardScreen() {
  ...
  const ALL_APPS: HomeAppDef[] = useMemo(
    () => [
      ...
      { key: 'clients', title: 'My Clients', subtitle: 'Track client work', icon: 'people', color: '#0D9488', action: 'clients' },
      { key: 'chatgd', title: 'ChatGD', subtitle: 'Ask a question', icon: 'chatbubbles', color: '#AF52DE', action: 'chatgd' },
      { key: 'intake', title: 'Intake', subtitle: 'Request documents', icon: 'checkbox-outline', color: '#14B8A6', action: 'intake' },
      { key: 'calendar', title: 'Calendar', subtitle: 'Schedule events', icon: 'calendar-outline', color: '#5856D6', action: 'calendar' },
      { key: 'meeting-call', title: 'Reach', subtitle: 'Start a meeting', icon: 'call', color: '#007AFF', action: 'meeting-call', showLive: reachInMeeting },
      {
        key: 'signatures',
        title: 'Signatures',
        subtitle: 'Send for signature',
        icon: 'create',
        iconElement: <SignatureIcon size={22} color="#fff" />,
        color: '#0EA5E9',
        action: 'signatures',
      },
      { key: 'upload-links', title: 'File Request', subtitle: 'Collect files', icon: 'link', color: '#8E44AD', action: 'upload-links' },
      { key: 'form', title: 'Forms', subtitle: 'Create a form', icon: 'clipboard-outline', color: '#34C759', action: 'form' },
      { key: 'workspaces', title: 'Workspaces', subtitle: 'Collaborate with a team', icon: 'people', color: '#5856D6', action: 'workspaces' },
      { key: 'notes', title: 'Notes', subtitle: 'Manage your notes', icon: 'create-outline', color: '#5AC8FA', action: 'notes' },
      { key: 'bookmarks', title: 'Bookmarks', subtitle: 'Pin important files', icon: 'bookmark', color: '#FF9500', action: 'bookmarks' },
      { key: 'chat', title: 'Secure Messaging', subtitle: 'Message privately', icon: 'chatbubbles', color: '#FF2D55', action: 'chat' },
      { key: 'email-sync', title: 'Email Replies', subtitle: 'Draft a reply', icon: 'mail-outline', color: '#007AFF', action: 'email-sync' },
      { key: 'analytics', title: 'Financials', subtitle: 'Track expenses', icon: 'analytics', color: '#FF9500', action: 'analytics' },
    ],
    [reachInMeeting]
  );
